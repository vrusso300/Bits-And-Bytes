...
namespace Bits_And_Bytes_Vincenzo_Russo.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //Getters and setters for signinmanager
        ...
        //Getters and setters for useramanger
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //Upon registration, create a new customer object with attributes = model
                //object passed in through parameter from registerviewmodel
                ...
                if (result.Succeeded)
                {
                    ...
                    //Assign always as a customer role
                    ...
                    return RedirectToAction("TermsAndConditions", "Home");
                }
                AddErrors(result);
            }
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    result = await UserManager.AddLoginAsync(customer.Id, info.Login);
                    if (result.Succeeded)
                    {
